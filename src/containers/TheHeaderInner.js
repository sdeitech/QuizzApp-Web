        ...
        return (
            <header id="header" className="fixed-top">
                    ...
                    <nav className="navbar navbar-expand-lg navbar-dark">
                        ...
                        >
                            ...
                            >
                                ...
                                <a
                                    href={`#/searchRound?${this.state.searchKey}`}
                                    style={{ color: "#fff" }}
                                >
                                    Search{" "}
                                    <i
                            ...
                            <form className="form-inline my-2 my-lg-0">
                                <ul className="navbar-nav mr-auto">
                                    <div className="dropdown">
                                        <div
                                            className="dropdown-toggle cus_img"
                                            type="button"
                                            id="dropdownMenu2"
                                        ...
                                        <div
                                            className="dropdown-menu drop_menu"
                ...
                <CModal
                    ...
                    closeOnBackdrop={false}
                    onClose={() => this.setState({ confirmationModel: false })}
                    color="danger"
                    centered
                >
                    <CModalBody className="model-bg">
