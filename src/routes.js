...
const DetailContestWithPlay = React.lazy(() =>
    import("./views/contest/contest_detail")
);
const DetailContestWithQuestionList = React.lazy(() =>
    import("./views/contest/detail_with_question_list")
);
...
const Dashboard_Trending_Contest = React.lazy(() =>
    import("./views/dashboard_trending_contest/view")
);
const Dashboard_Trending_Rounds = React.lazy(() =>
    import("./views/dashboard_trending_round/view")
);
...
const routes = [
    ...
    {
        path: "/trending_contest",
        name: "Dashboard_Trending_Contest",
        component: Dashboard_Trending_Contest,
    },
    {
        path: "/trending_rounds",
        name: "Dashboard_Trending_Rounds",
        component: Dashboard_Trending_Rounds,
    },
    {
        path: "/contests/start_round",
        name: "StartRound",
    ...
    { path: "/edit_contest", name: "EditContest", component: EditContest },
    {
        ...
        name: "DetailContestWithPlay",
        component: DetailContestWithPlay,
    },
    {
        path: "/contests/game/start",
        name: "DetailContestWithQuestionList",
        component: DetailContestWithQuestionList,
    },
    ...
    {
        path: "/add_round_question",
        name: "AddRoundQuestion",
        component: AddRoundQuestion,
    },
    {
        path: "/edit_round_question",
        name: "EditRoundQuestion",
        component: EditRoundQuestion,
    },
    ...
    { path: "/round_words", name: "RoundWords", component: RoundWords },
    {
        path: "/add_round_word",
        name: "AddRoundWords",
        component: AddRoundWords,
    },
    {
        path: "/edit_round_word",
        name: "EditRoundWords",
        component: EditRoundWords,
    },
