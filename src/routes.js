...
const DetailContestWithRoundList = React.lazy(() =>
    import("./views/contest/detail_with_round_list")
);
...
const routes = [
    ...
    { path: "/edit_contest", name: "EditContest", component: EditContest },
    {
        ...
        name: "DetailContestWithRoundList",
        component: DetailContestWithRoundList,
    },
    {
