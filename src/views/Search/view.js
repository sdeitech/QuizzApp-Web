...
let isTrending='';
class SearchRound extends Component {
	constructor(props) {
        super(props);
        this.state = {
    ...
    handleApplyFilter(){
		...
		fetch(configuration.baseURL+"contest/contest?"+queryStr+"&isPaginationTrue=false", {
                method: "GET",
                headers: {
	...
	componentDidMount(){ 
		...
		fetch(configuration.baseURL+"contest/contest?isPaginationTrue=false", {
                method: "GET",
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
                                            ...
                                            return <div class="col-lg-3 col-md-4 col-sm-6" >
			                                	<div class="cate-box2">
			                                        ...
			                                        <div class="cat_title2" style={{ cursor:'pointer'}} >
			                                            ...
			                                            <p style={{cursor: 'pointer'}}  onClick={this.roundsListHandler.bind(this,e)} >{e.totalRound} {(e.totalRound > 1) ? 'Rounds' : 'Round'}</p>
														<p>{e.userName}</p>
