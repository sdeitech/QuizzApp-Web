                ...
                <main id="main">
                    ...
                    <section id="contest" class="d-flex align-items-center">
                        <div class="container">
                            ...
                            >
                                <div
                                    className="row groups-box"
                                    style={{ paddingTop: "30px" }}
                                >
                                    {this.state.listData.length > 0 ? (
                                        this.state.listData.map((e, key) => {
                                            return (
                                                <div className="col-lg-3 col-md-4 col-sm-6 groups-box-inner">
                                                    <div className="addfriend box_yellow">
                                                        ...
                                                        "Data Admin" ? null : (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <a
                                                                        className="btn  dropdown-toggle toggle-arrow"
                                                                        style={{
                                                                            position:
                                                                                "absolute",
                                                                            left: "-20px",
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <a
                                                                            className="dropdown-item"
                                                                            onClick={this.deleteSaveToItem.bind(
                                                                                this,
                                                                                e.saveToId
                                                                            )}
                                                                        >
                                        ...
                                        >
                                            {this.state.isEditMode ? (
                                                <button
                                                    ...
                                                    className="blue_btn light_blue_btn"
                                                    type="button"
                                                    onClick={this.EditSaveGroupModel.bind(
                                                        this
                                                    )}
                                                >
                                                    {this.state.isLoading ? (
