                    ...
                    <ToastContainer position="top-right" autoClose={25000} style={{top:'80px'}}/>
                        <section id="contest" class="d-flex align-items-center">
                            <div class="container">
                                ...
                                <div style={{float: 'left',width: '100%'}} class="contest-info">

                                    {

                                        (this.state.listData.length > 0) ? 
                                        this.state.listData.map((e, key) => {
                                                return  <div class="participate-list2">
                                                    <div class="inline">
                                                        <img src={(e.invitedByImage) ? e.invitedByImage : 'avatars/placeholder-user.png' }/>
                                                    </div>
                                                    ...
                                                    {
                                                        (e.type === 1) ? <div class="inline part_ico">
                                                        <button class="pink_btn" type="button" onClick={this.acceptReject.bind(this,e,'decline')}>Decline</button>
                                                        <button class="blue_btn" type="button" onClick={this.acceptReject.bind(this,e,'accept')}>Accept</button>
                                                    </div> : null
                                                    }
