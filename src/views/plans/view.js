        ...
        return (
            <>
                ...
                <main id="main">
                                        ...
                                        return (
                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                <div
                                                    className={
                                                        "main_plan " +
                                                        val1.subscriptionCode.toLowerCase()
                                                    }
                                                >
                                                    <h3>{val1.title}</h3>
                                                    <h5>
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={this.handlePurcaseClick.bind(
                                                            this,
                                                            val1._id,
                                                            val1.subscriptionCode
                                                        )}
                                                    >
                                                        {val1.subscriptionCode ===
                                                        "BASIC"
                    ...
                    <CModal
                        show={this.state.purchaseModel}
                        closeOnBackdrop={false}
                        onClose={() => this.setState({ purchaseModel: false })}
                        color="danger"
                        centered
                    >
                                    ...
                                    <div className="model_data">
                                        ...
                                        >
                                            <button
                                                ...
                                                type="button"
                                                onClick={this.handlePurcaseSubmitClick.bind(
                                                    this
                                                )}
                                            >
                                                Submit
