			                            ...
			                            <div class="row">
                                            ...
                                            <div class="col-md-5">
				                                <div className="search">
			                                        <input placeholder="Search by keywords" type="text" onChange={this.handleChange.bind(this)} value={this.state.searchKey} /><i className='bx bx-search' ></i> 
			                                    </div>
                                            ...
                                            <div class="col-md-2">
                                              <button className="yellow_btn" type="button" onClick={this.handleSearch.bind(this)} >Search</button>                                   
			                                </div> 
			                            </div>
                                        <div style={{marginTop: '25px'}} class="row"> 
                                        {this.state.isLoading ? ( <h4  className="col-lg-12 col-md-12 col-sm-12 leaderloading">Loading...</h4>):(null) }
                                        {this.state.listData.length > 0 ? (this.state.listData.map((i, index) => (
                                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                                        <div class="_1st2 two_no">
                                                            <div class="_1stimg">
                                                                <div class="leaderimg2_">
                                                                    <img src={ (i.image !== '') ? i.image : 'avatars/placeholder-user.png' }/>
                                                                    <img class="onlinetick" style={{
                                                                        position: "absolute",
                                                                        width: "25px",
                                                                        height: "25px"}} src={i.availabilityStatus == 1 ? ('img/online.png'):(i.availabilityStatus == 2 ? ('img/away.png'):(i.availabilityStatus == 3 ?('img/donot-disturb.png'):(i.availabilityStatus == 4 ? ('img/invisible.png'):('img/online.png'))))} />
                                                                </div>
                                                    ...
                                                    this.state.isLoading == false ? ( <div style={{color:'white',width: '100%',textAlign:'center',marginTop:"150px",marginBottom:"150px"}} className="flex"><p className="item-author text-color">No data found</p></div>):(null) 
