...
class RoundQuestion extends Component {
    ...
    editHandler(data) {
        this.setState({
            fields: { question: data.title },
            errors: { question: "" },
            openModel: true,
            edit_id: data.item_id,
        });
    }
        ...
        return (
            <>
                                ...
                                <div className="model_data">
                                    ...
                                    <div className="full_btn">
                                        <button
                                            ...
                                            className="yellow_btn"
                                            type="button"
                                            onClick={this.savequestionModel.bind(
                                                this
                                            )}
                                        >
                                            {this.state.edit_id !== ""
                        ...
                        <div>
                            <div className="modal-body">
                                <button
                                    ...
                                    className="close"
                                    onClick={() =>
                                        this.setState({ optionsModel: false })
                                    }
                                >
                                    <span aria-hidden="true">
                                        <img src="./murabbo/img/close.svg" />
                ...
                <CModal
                    ...
                    closeOnBackdrop={false}
                    onClose={() => this.setState({ subscriptionModel: false })}
                    color="danger"
                    centered
                >
                    <CModalBody className="model-bg">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="model_data">
                                    <div className="model-title">
                                        ...
                                        />
                                        <h3>
                                            You need to purchase subscription.
                                        </h3>
                                    </div>
                                    <img
                                        className="shape2"
                ...
                <CModal
                    ...
                    closeOnBackdrop={false}
                    onClose={() => this.setState({ optionsValuesModel: false })}
                    color="danger"
                    centered
                >
                    <CModalBody className="model-bg">
