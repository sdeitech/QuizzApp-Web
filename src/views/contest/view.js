...
class Contest extends Component {
    ...
    componentDidMount() {
        ...
        var searchSaveToId = "";
        if (saveToId[1]) {
            searchSaveToId = saveToId[1].substring(
                0,
                saveToId[1].lastIndexOf("&")
            );
            if (searchSaveToId !== "") {
                this.setState({
                    saveToId: searchSaveToId,
                    saveToTitle: saveToId[1].substring(
                        saveToId[1].lastIndexOf("&") + 1
                    ),
                });
            }
        }
                    ...
                    <section id="contest" class="d-flex align-items-center">
                        <div class="container">
                            ...
                            <div
                                ...
                                class="contest-info dashboard-contest"
                            >
                                <div class="row">
