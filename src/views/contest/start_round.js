...
class StartRound extends Component {
    ...
    componentDidMount() {
        ...
        socket_2.on("resultQuestion", ({ resultInfo }) => {
            if (this.props.isModerator) {
                if (
                    this.state.roundListArr[this.state.currentIndexRound] !==
                    undefined
                ) {
                    if (
    ...
    getRoomDetails() {
        fetch(
            configuration.baseURL + "room/room/?roomId=" + this.state.roomIdd,
            {
                method: "GET",
                headers: {
                    Accept: "application/json",
        ...
        return (
            <>
                                    ...
                                    this.state.saveExitAnswer === false ? (
                                                    ...
                                                    >
                                                        ...
                                                        {this.state
                                                            ...
                                                            <button
                                                                ...
                                                                class="pink_btn"
                                                                type="button"
                                                                onClick={this.getParticipants.bind(
                                                                    this
                                                                )}
                                                            >
                                                                Give Score
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <button
                                                                ...
                                                                class="pink_btn"
                                                                type="button"
                                                                onClick={this.saveExitAnswerForBlank.bind(
                                                                    this
                                                                )}
                                                            >
                                                                Start Next Round
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {this.state
                                                    .isWinnerScreenShow ? (
                                                    this.state.activelistArr
                                                        .length > 0 ? (
                                                        this.state.activelistArr.map(
                                                            (e, i) => {
                                                                return (
                                                                    <>
                                                                        <h3
                ...
                <CModal
                    ...
                    closeOnBackdrop={false}
                    onClose={() =>
                        this.setState({ openModelForMembers: false })
                    }
                    color="danger"
                    centered
                >
