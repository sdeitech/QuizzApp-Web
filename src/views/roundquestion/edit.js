...
class EditRoundQuestion extends Component {
                        ...
                        fetch(
                            ...
                            .then((data) => {
                                if (data.data.length > 0) {
                                    ...
                                    fields["answerType"] =
                                        gameType !== "Taboo"
                                            ? data.data[0]["answerType"]
                                            : 4;
                                    fields["timeLimitSeconds"] =
                                        fields["timeLimit"];
                                    fields["execution_mode"] =
                                        newdata.execution_mode;
    ...
    onChangeCategoryImage(e) {
        ...
        fetch(
            configuration.APIbaseURL + "image/image?category=" + e.target.value,
            {
                method: "GET",
                headers: {
                    contentType: "application/json",
    ...
    updateHandler(e) {
        ...
        if (
            ...
            if (fields["hintText"].trim() === "") {
                errors["hintText"] = "Please enter hint";
                formIsValid = false;
            }
        }
        ...
        if (formIsValid) {
            if (
                ...
                parseInt(this.state.fields["answerType"]) !== 5
            ) {
                this.setState({
                    tosterMsg:
                        this.state.fields["gameType"] !== "Taboo"
                            ? "Please add at least one answer"
                            : "Please add at least one taboo",
                });
                return false;
            }

            if (
                this.state.fields["gameType"] === "GuessAndGo" &&
            ...
            if (parseInt(this.state.fields["answerType"]) !== 5) {
                ...
                if (temp === false) {
                    errors["correctAnswer"] =
                        "Select atleast one answer correct!";
                    this.setState({ errors: errors });
                    return false;
                }
            }
            ...
            if (
                this.state.fields.execution_mode === 2 ||
                this.state.fields.execution_mode === "2"
            ) {
                ...
                data.append(
                    "negativeScoring",
                    this.state.fields.negativeScoring
                );
                data.append(
                    "negativeBasePoints",
            ...
            if (
                this.state.fields.answerType !== 5 &&
                this.state.fields.answerType !== "5"
            ) {
                ...
                data.append(
                    "answerTypeBoolean",
                    this.state.fields.answerTypeBoolean
                );
            }
            ...
            if (this.state.fields["gameType"] !== "Taboo") {
                if (
                    this.state.fields.image !== "undefined" &&
                    this.state.fields.image === "image"
                ) {
            ...
            fetch(
                ...
                .then((data) => {
                    ...
                    this.props.history.push(
                        "/roundquestion/" + contest_id + "/" + round_id
                    );
                });
        }
    }
    ...
    openModel() {
        this.setState({
            fieldsAnswer: { answer: "", correctAnswer: false },
            errorsAnswer: { answer: "" },
            openModel: true,
            edit_id: "",
        });
    ...
    saveAnswerModel() {
        ...
        if (formIsValid) {
            ...
            if (this.state.edit_id !== "") {
                ...
                if (
                    parseInt(this.state.fields["answerType"]) !== 1 &&
                    parseInt(this.state.fields["answerType"]) !== 2
                ) {
    ...
    changeAnswer(key, type, e) {
        ...
        answers = answers.filter(function (value, index, arr) {
            if (key === index) {
                ...
                if (
                    parseInt(that.state.fields["answerType"]) === 1 &&
                    type === "check"
                ) {
                    var obj = value;
    ...
    removeImage(event) {
        ...
        if ($(".display-profile-pic").attr("src") !== "") {
            this.setState({
                isexitImage: $(".display-profile-pic").attr("src"),
            });
        }
        fields["fileType"] = "";
        fields["image"] = "";
        ...
        return (
            <>
                ...
                <main id="main">
                        ...
                        <div className="container">
                            ...
                            >
                                ...
                                <div className="row">
                                    ...
                                    "Taboo" ? (
                                        <div className="col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            >
                                                <form
                                                    id="file-upload-form"
                                                    className="uploader question-add-edit"
                                                >
                                                    <label id="file-drag">
                                                        <img
                                                            id="file-image"
                                                        ...
                                                        />
                                                        <video
                                                            className="video1 video-width"
                                                            id="video_here"
                                                            controlsList="nodownload"
                                                            onLoadedMetadata={this.checkVideoDuration.bind(
                                                                this
                                                            )}
                                                            controls
                                                        >
                                                        ...
                                                        <audio
                                                            ...
                                                            id="audio_here"
                                                            onLoadedMetadata={this.checkAudioDuration.bind(
                                                                this
                                                            )}
                                                            controls
                                                            controlsList="nodownload"
                                    ...
                                    {this.state.fields["execution_mode"] ===
                                        2 ||
                                    this.state.fields["execution_mode"] ===
                                        "2" ? (
                                        <div className="col-lg-4 col-md-6 col-sm-12">
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        this.state.fields["execution_mode"] ===
                                            "2" ? (
                                            this.state.fields["hint"] === 3 ||
                                            this.state.fields["hint"] ===
                                                "3" ? (
                                                <div>
                                                    <div
                                                        style={{
                                        ...
                                        this.state.fields["answerType"] ===
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <img
                                                        src="./murabbo/img/negativeSign.png"
                                                        alt="Upload"
                                                    />
                                                    <label className="cus_label">
                                                        Select Answer{" "}
                                    ...
                                    <div className="model_data">
                                        ...
                                        <div className="cus_input input_wrap">
                                            <input
                                                ...
                                                required
                                                name=""
                                                onChange={this.handleChangeAnswer.bind(
                                                    this,
                                                    "answer"
                                                )}
                                                value={
                                                    this.state.fieldsAnswer[
                                                        "answer"
                                                    ]
                                                }
                                            />
                                        ...
                                        <span className="error-msg">
                                            {this.state.errorsAnswer["answer"]}
                                        </span>
                                        ...
                                        <div className="full_btn">
                                            <button
                                                ...
                                                type="button"
                                                onClick={this.saveAnswerModel.bind(
                                                    this
                                                )}
                                            >
                                                Done
                    ...
                    <CModal
                        show={this.state.optionsModel}
                        closeOnBackdrop={false}
                        onClose={() => this.setState({ optionsModel: false })}
                        color="danger"
                        centered
                    >
                        <CModalBody className="model-bg">
                    ...
                    <CModal
                        show={this.state.optionsValuesModel}
                        closeOnBackdrop={false}
                        onClose={() =>
                            this.setState({ optionsValuesModel: false })
                        }
                                                        ...
                                                        <div class="col-md-12">
                                                            <div className="search">
                                                                <input
                                                                    ...
                                                                    type="text"
                                                                    onChange={this.handleChangeSearchImage.bind(
                                                                        this,
                                                                        "searchKey"
                                                                    )}
                                                                    value={
                                                        ...
                                                        <div className="col-md-12 mt-3">
                                                            <div className="dropdown">
                                                                <select
                                                                    ...
                                                                    onChange={this.onChangeCategoryImage.bind(
                                                                        this
                                                                    )}
                                                                >
                                                                    <option
                                                        ...
                                                        <div class="col-md-12">
                                                            <div className="search">
                                                                <input
                                                                    placeholder="Search by keywords"
                                                                    type="text"
                                                                    onChange={this.handleChangeSearchAudio.bind(
                                                                        this,
                                                                        "searchKey"
                                                                    )}
                                                                    value={
                                                        ...
                                                        <div className="col-md-12 mt-3">
                                                            <div className="dropdown">
                                                                <select
                                                                    ...
                                                                    onChange={this.onChangeCategoryAudio.bind(
                                                                        this
                                                                    )}
                                                                >
                                                                    <option
                                                        ...
                                                        <div className="col-md-12">
                                                            <div className="cus_input input_wrap">
                                                                ...
                                                                <input
                                                                    ...
                                                                    required
                                                                    name=""
                                                                    onChange={this.handleChangeForYoutube.bind(
                                                                        this,
                                                                        "url"
                                                                    )}
                                                                    value={
