    ...
    constructor(props) {
        ...
        this.state = {
            ...
            fields: {
                ...
                timeLimit: "00:30",
                basePoints: 100,
                negativeBasePoints: 50,
                execution_mode: 0,
                scoring: 2,
                negativeScoring: false,
                hint: 3,
                answerType: 1,
                onDemandNegativePoints: 25,
                                    ...
                                    <div className="model_data questionOptionModel">
                                        ...
                                        >
                                            ...
                                            >
                                                <input
                                                    id="file-upload"
                                                    accept="video/mp4,audio/mp3,image/gif,image/jpeg,image/png,.gif,.jpeg,.jpg,.png"
                                                    type="file"
                                                    name="fileUpload"
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div class="cat_title2">
                                                                            <p className="paid-media-title-btm-spc">
                                                                                {shortTitle(
                                                                                    e.title,
                                                                                    15
                                                                                )}
