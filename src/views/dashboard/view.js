                    ...
                    <section id="contest" class="d-flex align-items-center">
                        <div class="container">
                            <div
                                ...
                                class="contest-info banner-div"
                            >
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="cate-box2">
                                            <img
                                                src="./murabbo/img/banner.png"
                                                alt="Game"
                                                className="banner"
                                            />
                                        </div>
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6">
                                                    <div class="cate-box2">
                                                        ...
                                                        <div class="cat_title2">
                                                            ...
                                                            <p
                                                                className="join_btn_contest"
                                                                onClick={this.joinRoomContest.bind(
                                                                    this,
                                                                    e
                                                                )}
                                                                style={{
