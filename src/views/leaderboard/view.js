...
class Leaderboard extends Component {
	...
	componentDidMount(){
        ...
        fetch(configuration.baseURL+"user/leaderboard?size=10&page=1&userId="+userId, {
                method: "GET",
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    fetchMoreData(){
        ...
        setTimeout(() => {
            fetch(configuration.baseURL+"user/leaderboard?size=10&page="+this.state.currentPage+"&userId="+userId, {
                    method: "GET",
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
                                ...
                                <div style={{ marginTop: '30px'}} class="contest-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">
                                            ...
                                            <div style={{marginBottom: '25px'}} class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <h3 class="setting-title">Top Ranks</h3>
                                                </div>
                                                <InfiniteScroll className="row"
                                                    dataLength={this.state.items.length}
                                                    next={this.fetchMoreData.bind(this)}
                                                    hasMore={this.state.hasmore}
                                                    loader={<h4 className="col-lg-12 col-md-12 col-sm-12 leaderloading">Loading...</h4>}
                                                    ...
                                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                                        <div class="_1st2 two_no">
                                                            <div class="_1stimg">
                                                                ...
                                                                <div class="point_">
                                                                    <h5>{i.currentScore} pt</h5>
                                                                    <img class="up-arrow" src="./murabbo/img/up-arrow.svg"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
